...
{
    public class BloodRenewalSpell : BarbarianSpell
    {
        private static SpellInfo m_Info = new SpellInfo(
                "Blood Renewal", "á aftur frá Hel",
                245,
                9062
            );
            ...
            public override double RequiredSkill{ get { return 100; } }
            public override int RequiredMana{ get{ return 100; } } // Uses Stamina Instead of Mana
            public override int RequiredStains{ get{ return 120; } }
            public override bool BlocksMovement{ get{ return false; } }
            private PlayerMobile barbarian;
 
        public BloodRenewalSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
        {
        }
        ...
        {
            private BloodRenewalSpell m_Owner;
 
            public InternalTarget( BloodRenewalSpell owner ) : base( 1, false, TargetFlags.Beneficial )
            {
                m_Owner = owner;
            }
