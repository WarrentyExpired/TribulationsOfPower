...
namespace Server.Spells.Barbarian
{
	public class BloodThirstSpell : BarbarianSpell
	{
		...
		public override int RequiredMana{ get{ return 10; } } // Uses Stamina instead of Mana
		...
		public override void OnCast()
		{
			...
			{
                        	Caster.PrivateOverheadMessage(MessageType.Regular, 0x3B2, false, "Your enemies wounds will heal you.", Caster.NetState);
				//Caster.SendMessage( "Your enemies wounds will heal you.");
